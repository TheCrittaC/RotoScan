...
class RotoScanGUI extends JPanel{
	...
	right = new JPanel(new GridLayout(11,1,0,5));
	...
	startStop.addActionListener(new ActionListener(){
		public void actionPerformed(ActionEvent e){
			...
			CFBBox.setEnabled(false);
			emailBox.setEnabled(false);
			textBox.setEnabled(false);
			//disables all checkboxes once the start button is clicked
			emailField.setEnabled(false);
			textField.setEnabled(false);
			yourEmailField.setEnabled(false);
			passwordField.setEnabled(false);
			//disables all text fields once start button is clicked
			...
			CFBBox.setEnabled(true);
			emailBox.setEnabled(true);
			textBox.setEnabled(true); //enables all checkboxes
			emailField.setEnabled(true);
			textField.setEnabled(true);
			yourEmailField.setEnabled(true);
			passwordField.setEnabled(true); //enables all text fields
	...
	this.add(left, "West");
	this.add(right, "East"); //adds the left and right sides
...
public class GUIDriver extends CloseableFrame{
    public GUIDriver(){
	setTitle("RotoScan"); //sets window title
	setPreferredSize(new Dimension (500,375)); //sets initial window size
	Container contentPane = getContentPane();
	contentPane.add(new RotoScanGUI()); //adds components
	pack();
	setVisible(true); //draws frame
    }
    public static void main(String[] args){
	GUIDriver g = new GUIDriver(); //creates our frame
    }
}
